...
icon='F:/DS/MDTM20/VS Code/GUVI_LLM/chatbot.png'
...
def login():
    ...
    with col2:
        st.image('F:/DS/MDTM20/VS Code/GUVI_LLM/login.png', width = 320)  
...
def home_page():
    ...
    with st.sidebar:
        ...
        st.image('F:/DS/MDTM20/VS Code/GUVI_LLM/Guvi.jpeg', width = 200)
    ...
    with col2:
        st.image('F:/DS/MDTM20/VS Code/GUVI_LLM/chatbot.png', width = 500) 
